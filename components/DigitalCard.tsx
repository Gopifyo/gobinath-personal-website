...
export const DigitalCard = () => {
    ...
    const downloadPDF = async () => {
        ...
        try {
            ...
            pdf.save(`gobinath-card-${isFlipped ? 'back' : 'front'}.pdf`);
        } catch (err) {
        ...
        <div className="w-full flex flex-col items-center gap-8 animate-in fade-in slide-in-from-bottom-8 duration-1000">
            ...
            <div className="relative w-full max-w-md aspect-[1.75/1] group perspective-1000">
                ...
                >
                    ...
                    {/* FRONT SIDE */}
                    {!isFlipped ? (
                        <div className="relative h-full flex flex-col justify-between p-6 md:p-8 z-10 animate-in fade-in duration-500">
                            {/* Header */}
                            ...
                            <div className="flex justify-between items-end mt-4">
                                <div className="space-y-2">
                                    ...
                                    <div className="flex items-center gap-2 text-zinc-400 text-xs">
                                        ...
                                        <span className="tracking-wide">gobinath-dev.com</span>
                                    </div>
